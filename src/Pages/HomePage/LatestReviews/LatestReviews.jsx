  ...
  return (
    <div className="bg-orange-50/80">
      <div className="pt-20 lg:pt-20 pb-20 lg:pb-30 px-6 max-w-[1620px] mx-auto">
        <h4 className="font-medium text-xl lg:text-2xl text-orange-500 flex  justify-center items-center mb-2 md:mb-4 lg:mb-6">
          <IoMdHome className="mr-4"></IoMdHome>REVIEWS HIGHLIGHTS{" "}
          <IoMdHome className="ml-4 "></IoMdHome>
        </h4>
        <div className="divider before:bg-[#1b2a4f] after:bg-[#1b2a4f] text-[#1b2a4f] text-2xl md:text-3xl xl:text-4xl font-bold mb-24">
          Latest Reviews
        </div>
        {reviews.length === 0 ? (
