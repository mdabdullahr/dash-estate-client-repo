...
const AdvertisementSection = () => {
  ...
  return (
    <div className="pt-30 px-4 max-w-[1320px] mx-auto">
      <div className="divider before:bg-green-700 after:bg-green-700 text-green-700 text-xl md:text-2xl xl:text-3xl font-bold mb-12">Featured Advertised Properties</div>
